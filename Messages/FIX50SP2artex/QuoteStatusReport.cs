...
namespace QuickFix
{
    namespace FIX50SP2 
    {
        public class QuoteStatusReport : Message
        {
            ...
            public QuickFix.Fields.BidQuoteID BidQuoteID
            { 
                get 
                {
                    QuickFix.Fields.BidQuoteID val = new QuickFix.Fields.BidQuoteID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BidQuoteID val) 
            { 
                this.BidQuoteID = val;
            }
            
            public QuickFix.Fields.BidQuoteID Get(QuickFix.Fields.BidQuoteID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BidQuoteID val) 
            { 
                return IsSetBidQuoteID();
            }
            
            public bool IsSetBidQuoteID() 
            { 
                return IsSetField(Tags.BidQuoteID);
            }
            public QuickFix.Fields.OfferQuoteID OfferQuoteID
            { 
                get 
                {
                    QuickFix.Fields.OfferQuoteID val = new QuickFix.Fields.OfferQuoteID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.OfferQuoteID val) 
            { 
                this.OfferQuoteID = val;
            }
            
            public QuickFix.Fields.OfferQuoteID Get(QuickFix.Fields.OfferQuoteID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.OfferQuoteID val) 
            { 
                return IsSetOfferQuoteID();
            }
            
            public bool IsSetOfferQuoteID() 
            { 
                return IsSetField(Tags.OfferQuoteID);
            }
            public QuickFix.Fields.BidMDEntryID BidMDEntryID
            { 
                get 
                {
                    QuickFix.Fields.BidMDEntryID val = new QuickFix.Fields.BidMDEntryID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BidMDEntryID val) 
            { 
                this.BidMDEntryID = val;
            }
            
            public QuickFix.Fields.BidMDEntryID Get(QuickFix.Fields.BidMDEntryID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BidMDEntryID val) 
            { 
                return IsSetBidMDEntryID();
            }
            
            public bool IsSetBidMDEntryID() 
            { 
                return IsSetField(Tags.BidMDEntryID);
            }
            public QuickFix.Fields.OfferMDEntryID OfferMDEntryID
            { 
                get 
                {
                    QuickFix.Fields.OfferMDEntryID val = new QuickFix.Fields.OfferMDEntryID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.OfferMDEntryID val) 
            { 
                this.OfferMDEntryID = val;
            }
            
            public QuickFix.Fields.OfferMDEntryID Get(QuickFix.Fields.OfferMDEntryID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.OfferMDEntryID val) 
            { 
                return IsSetOfferMDEntryID();
            }
            
            public bool IsSetOfferMDEntryID() 
            { 
                return IsSetField(Tags.OfferMDEntryID);
            }
