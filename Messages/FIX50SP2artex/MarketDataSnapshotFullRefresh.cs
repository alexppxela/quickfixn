...
namespace QuickFix
{
    namespace FIX50SP2 
    {
        public class MarketDataSnapshotFullRefresh : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.MDEntryType, Tags.MDEntryPx, Tags.MDEntrySize, Tags.MDEntryDate, Tags.MDEntryTime, Tags.OrderID, Tags.QuoteEntryID, Tags.Text, Tags.OrdType, Tags.TradeID, Tags.TradeCondition, Tags.OpenCloseSettlFlag, 0};
