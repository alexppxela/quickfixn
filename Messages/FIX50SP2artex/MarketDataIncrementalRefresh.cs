...
namespace QuickFix
{
    namespace FIX50SP2 
    {
        public class MarketDataIncrementalRefresh : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.MDUpdateAction, Tags.MDEntryType, Tags.MDEntryID, Tags.Symbol, Tags.SecurityID, Tags.SecurityIDSource, Tags.Currency, Tags.MDEntryPx, Tags.MDEntrySize, Tags.MDEntryDate, Tags.MDEntryTime, Tags.OrderID, Tags.QuoteEntryID, Tags.Text, Tags.OrdType, Tags.TradeID, Tags.MarketDepth, Tags.TradeCondition, Tags.OpenCloseSettlFlag, 0};
